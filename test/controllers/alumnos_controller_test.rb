...
class AlumnosControllerTest < ActionController::TestCase
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post :create, alumno: { Account: @alumno.Account, Career: @alumno.Career, Lastname: @alumno.Lastname, Name: @alumno.Name, Telephone: @alumno.Telephone }
    end
  ...
  test "should update alumno" do
    patch :update, id: @alumno, alumno: { Account: @alumno.Account, Career: @alumno.Career, Lastname: @alumno.Lastname, Name: @alumno.Name, Telephone: @alumno.Telephone }
    assert_redirected_to alumno_path(assigns(:alumno))
  end
